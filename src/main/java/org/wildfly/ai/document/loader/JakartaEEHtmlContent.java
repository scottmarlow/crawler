...
/**
 * JakartaEEHtmlContent
 *
 * @author Scott Marlow
 */
public class JakartaEEHtmlContent implements DocumentSource {
    private final Path path;
    private final String language;
    private final String url;
    private final String parentUrl;

    public JakartaEEHtmlContent(Path path, String language, String url, String parentUrl) {
        this.path = path;
    ...
    public boolean equals(Object obj) {
        ...
        final JakartaEEHtmlContent other = (JakartaEEHtmlContent) obj;
